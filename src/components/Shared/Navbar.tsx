  ...
  return (
    <div className="flex items-center justify-between p-4 bg-gray-800 text-white">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          onClick={onLogout}
          className="flex items-center gap-2 p-2 rounded-md text-gray-300 hover:text-white hover:bg-red-500 transition duration-300"
        >
          <svg
        ...
        >
          ...
          {theme === "light" ? (
            ...
            <svg
              className={`swap-off h-8 w-8 fill-current text-gray-400`}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
